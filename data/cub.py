...
class CustomCub2011(Dataset):
    ...
    def _load_classnames(self):
        classesnames = []
        with open(os.path.join(self.root, 'CUB_200_2011', 'classes.txt'), "r") as file:
            for line in file:
                classesnames.append(line.strip().split(".")[1].replace("_"," "))
...
def get_cub_datasets(train_transform, test_transform, train_classes=range(160), prop_train_labels=0.8,
    ...
    classesname = whole_training_set.classnames
    ...
    return all_datasets , classesname
